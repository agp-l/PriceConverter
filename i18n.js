...
const messages = {
  cs: {
    ...
    chartTitle:'Graf BTC/USD', chartPeriod:'BTC/USD · 1 rok', openChart:'Otevřít graf ↗',
    ...
    donateBitcoin:'Bitcoin', donateLightning:'Lightning · nabídka BOLT12', copyAddress:'Kopírovat adresu',
    copyOffer:'Kopírovat nabídku', openWallet:'Otevřít peněženku',
    offerHint:'Použijte peněženku, která podporuje nabídky BOLT12.',
  ...
  en: {
    ...
    chartTitle:'BTC/USD chart', chartPeriod:'BTC/USD · 1 year', openChart:'Open chart ↗',
    ...
    donateBitcoin:'Bitcoin', donateLightning:'Lightning · BOLT12 offer', copyAddress:'Copy address',
    copyOffer:'Copy offer', openWallet:'Open wallet',
    offerHint:'Use a wallet that supports BOLT12 offers.',
