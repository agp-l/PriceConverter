...
const messages = {
  cs: {
    ...
    rateSourcesHint:'Vyberte alespoň jeden zdroj. Je-li dostupných více kurzů, aplikace je zprůměruje.',
  ...
  en: {
    ...
    rateSourcesHint:'Choose at least one source. Available rates are averaged when more than one responds.',
