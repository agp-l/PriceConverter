...
const messages = {
  cs: {
    ...
    travelEyebrow:'NA CESTÁCH', travelHeading:'Měna za měnu', travelIntro:'Rychlý přepočet dvou měn. Směr otočíte jedním klepnutím.', travelAmount:'Kolik převést',
  ...
  en: {
    ...
    travelEyebrow:'ON THE ROAD', travelHeading:'Currency to currency', travelIntro:'Convert between two currencies and swap the direction with one tap.', travelAmount:'Amount to convert',
