...
export const messages = {
  cs: {
    ...
    installButton:'Nainstalovat aplikaci', androidApkDownload:'Stáhnout APK pro Android', androidApkNote:'Testovací sestavení. Při aktualizaci může být potřeba starou verzi odinstalovat.', openSource:'Zdrojový kód na GitHubu', donate:'Podpořit projekt',
  ...
  en: {
    ...
    installButton:'Install app', androidApkDownload:'Download Android APK', androidApkNote:'Test build. Updating may require uninstalling the previous version.', openSource:'Source code on GitHub', donate:'Support the project',
